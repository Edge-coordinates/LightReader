  ...
  return {
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'edge-light-reader',
        productName: 'Light Reader',
        directories: {
          output: 'dist',
        ...
        nsis: {
          ...
          installerIcon: './public/icons/reader.ico', // 安装图标
          uninstallerIcon: './public/icons/bbb.ico', //卸载图标
          installerHeaderIcon: './public/icons/reader.ico', // 安装时头部图标
          createDesktopShortcut: true, // 创建桌面图标
          createStartMenuShortcut: true, // 创建开始菜单图标
          shortcutName: 'Light Reader', // 图标名称
        },
      },
    },
